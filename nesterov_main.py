...
def main():
    ...
    # print("Performing hyperfast method with quartic regularization...")
    # loss_h, grad_h, theta_star = hyperfast(start_theta, num_iters, nesterov_problem)
    ...
    # plt.loglog((loss_o1 - nesterov_problem.ideal_minimum()), label="Gradient Descent")  # - nesterov_problem.ideal_minimum()
    # plt.loglog((loss_o1_a - nesterov_problem.ideal_minimum()), label="Acc. Gradient Descent")
    ...
    plt.semilogy(loss_o2_acc - nesterov_problem.ideal_minimum(), label="Acc. Newton")
    # plt.semilogy(loss_h - nesterov_problem.ideal_minimum(), label="Hyperfast")
